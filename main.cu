...
static double forward_pass(unsigned char data[32][32][3])
{
    ...
    fp_preact_f<<<64, 64>>>((float (*)[7][7])l_s1.output, l_f.preact, (float (*)[6][7][7])l_f.weight);
    fp_bias_f<<<64, 64>>>(l_f.preact, l_f.bias);
    // Using softmax activation for output layer instead of step function
    apply_softmax_function<<<64, 64>>>(l_f.preact, l_f.output, l_f.O);
...
static double back_pass()
{
    ...
    bp_weight_f<<<64, 64>>>((float (*)[6][7][7])l_f.d_weight, l_f.d_preact, (float (*)[7][7])l_s1.output);
    bp_bias_f<<<64, 64>>>(l_f.bias, l_f.d_preact);

    // Backpropagate through subsampling layer
    bp_output_s1<<<64, 64>>>((float (*)[7][7])l_s1.d_output, (float (*)[6][7][7])l_f.weight, l_f.d_preact);
    bp_preact_s1<<<64, 64>>>((float (*)[7][7])l_s1.d_preact, (float (*)[7][7])l_s1.d_output, (float (*)[7][7])l_s1.preact);
    bp_weight_s1<<<64, 64>>>((float (*)[4][4])l_s1.d_weight, (float (*)[7][7])l_s1.d_preact, (float (*)[28][28])l_c1.output);
    bp_bias_s1<<<64, 64>>>(l_s1.bias, (float (*)[7][7])l_s1.d_preact);

    // Backpropagate through convolutional layer
    bp_output_c1<<<64, 64>>>((float (*)[28][28])l_c1.d_output, (float (*)[4][4])l_s1.weight, (float (*)[7][7])l_s1.d_preact);
    bp_preact_c1<<<64, 64>>>((float (*)[28][28])l_c1.d_preact, (float (*)[28][28])l_c1.d_output, (float (*)[28][28])l_c1.preact);
    bp_weight_c1<<<64, 64>>>((float (*)[5][5][3])l_c1.d_weight, (float (*)[28][28])l_c1.d_preact, (float (*)[32][3])l_input.output);
    bp_bias_c1<<<64, 64>>>(l_c1.bias, (float (*)[28][28])l_c1.d_preact);
